    ...
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                <?php echo form_open_multipart('dashboard/web_setting/common_create', 'class="form-inner"') ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9 customesl">
                        <select name="membershipenable" class="form-control">
                            ...
                            <option value="1" <?php if ($websetting->ismembership == 1) {
                                                    echo "selected";
                                                } ?>><?php echo display('active') ?></option>
                            <option value="0" <?php if ($websetting->ismembership == 0) {
                                                    echo "selected";
