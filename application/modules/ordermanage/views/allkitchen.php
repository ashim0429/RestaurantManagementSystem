                                            ...
                                            ?>
                                                    <div class="grid-col col-vxs-12 col-xs-6 col-md-4 col-lg-3 col-xlg-4" id="singlegrid<?php echo $orderinfo->order_id . $orderinfo->kitchenid; ?>">
                                                        <div class="grid-item-content" id="gridcontent<?php echo $orderinfo->order_id . $orderinfo->kitchenid; ?>">
                                                            ...
                                                            ?>
                                                            <div class="food_item <?php if ($isaccept == 0) {
                                                                                        echo "pending";
                                                                ...
                                                                <div class="cooking_time">
                                                                    ...
                                                                    ?>
                                                                    <h4 class="kf_info"><?php echo display('cookedtime') ?>:<?php if ($st == 1) { ?><span class="countdown_<?php echo $orderinfo->order_id;
                                                                                                                                                                            echo $c; ?>"></span><?php } else { ?><span><?php echo display('time_over');
                                                                                                                                                                                                                    } ?></span></h4>
                                                                </div>
                                                                    ...
                                                                    foreach ($iteminfo as $item) {
                                                                        ...
                                                                        <div class="single_item">
                                                                            <div class="align-center justify-between item-dv">
                                                                                <input id='chkbox-<?php echo $l . $item->kitchenid . $orderinfo->order_id; ?>' usemap="<?php echo $orderinfo->order_id; ?>" title="<?php echo $item->varientid; ?>" alt="<?php echo $isaccept; ?>" type='checkbox' <?php if ($ischecked == 1 && $isaccept == 0) {
                                                                                                                                                                                                                                                                                                        echo "checked disabled";
                                                                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                                                                    if ($isaccept == 1 && $item->food_status == 1) {
                                                                                                                                                                                                                                                                                                        echo "checked";
